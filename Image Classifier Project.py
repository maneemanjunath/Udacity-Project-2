...
data_transforms = transforms.Compose([transforms.RandomRotation(30),transforms.RandomResizedCrop(224),transforms.RandomHorizontalFlip(),transforms.ToTensor(),
...
model_ft = train_model(model, criterion, optim, sched, 10, 'cuda')
